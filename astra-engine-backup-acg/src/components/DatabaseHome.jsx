...
import { Search, Plus, User, Clock, MapPin, ChevronRight, Database, Star, Trash2, Info } from 'lucide-react';
...
const DatabaseHome = ({ onSelect, onCreateNew }) => {
  ...
  return (
    <div className="min-h-screen bg-[#F1E9DE] flex flex-col font-sans text-[#1F2226] selection:bg-[#D4AF37]/20">
