...
const TransitLaboratory = ({ chartData, transitData, onClose, activePlanets, activeAspects, activePatterns, onTimeChange, showTimeMachine, onToggleTimeMachine }) => {
