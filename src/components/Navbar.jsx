  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-serif italic text-sm tracking-tight text-[#1F2226] font-bold">Ad Astra</h2>
          <p className="text-[8px] font-mono uppercase tracking-[0.2em] text-[#8C8883] font-bold">V3.0 Professional</p>
        </div>
      </div>
